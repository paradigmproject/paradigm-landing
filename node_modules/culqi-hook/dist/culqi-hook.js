...
var CULQI_CHECKOUT = "https://checkout.culqi.com";
/**
...
var useCulqi = function (publicKey) {
  var ref = react.useState({
    ready: false
  });
  var response = ref[0];
  var setResponse = ref[1];
  var ref$1 = react.useState(document.createElement("iframe"));
  var f = ref$1[0];

  if (!response.ready) {
    f.style.display = "none";
    f.setAttribute("src", CULQI_CHECKOUT + "/?public_key=" + publicKey + "&title=Q3VscWkgU3RvcmU%3D&currency=UEVO&" + "description=UG9sbyBDdWxxaSBsb3Zlcg%3D%3D&" + "amount=MzUwMA%3D%3D&logo=aHR0cHM6Ly9zdGF0aWM" + "uY3VscWkuY29tL3YyL3YyL3N0YXRpYy9pbWcvbG9nby5wbmc%3D&" + "installments=false&orders=");
  ...
  var generateToken = function (details) {
    if (response.ready) {
      setResponse(Object.assign({}, response,
        {loading: true}));
      f.contentWindow.postMessage({
...
exports.useCulqi = useCulqi;
//# sourceMappingURL=culqi-hook.js.map
